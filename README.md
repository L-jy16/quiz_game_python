...
13. 핵심 기술 적용
    ...
    4. 브랜치 사용 이유
       기능별 개발을 분리하여 협업과 관리 효율성을 높이기 위해 사용했습니다.

    5. 데이터 구조 설계
       퀴즈 데이터를 리스트와 딕셔너리 형태로 구성하여 관리했습니다.
...
15. 생각하기
    ...
    2. 데이터 손상 대응
       ...
       프로그램 실행 중 JSON 파일이 없거나, 파일 내용이 깨진 경우 오류가 발생할 수 있습니다. 이 문제를 해결하기 위해 try/except를 사용하여 오류를 처리하였고, 파일이 없거나 손상된 경우에는 기본 퀴즈 데이터를 다시 생성하도록 구현하였습니다.
